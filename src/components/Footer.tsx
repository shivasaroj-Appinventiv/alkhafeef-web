      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
          <div className="lg:max-w-[240px]">
            ...
            <nav className="mt-6 flex flex-col gap-3 text-sm text-slate-400">
              ...
              <a href="#" className="transition hover:text-white">Help & Support</a>
              <a href="#" className="transition hover:text-white">FAQs</a>
              <a href="#" className="transition hover:text-white">Catering</a>
            </nav>
          </div>

          <div>
            <h2 className="text-base font-semibold text-white">Explore Alkhafeef</h2>
            <nav className="mt-6 grid gap-3 text-sm text-slate-400 sm:grid-cols-2 sm:gap-4 lg:grid-cols-1">
              <a href="#" className="transition hover:text-white">Our Store</a>
              <a href="#" className="transition hover:text-white">Our Vision</a>
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-sm text-slate-400">
              ...
              <p className="inline-flex gap-2 items-start">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-slate-800 text-slate-300">
                  <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mt-10 border-t border-slate-800 pt-8 sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3 sm:mt-0">
            <a href="#" className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-800 bg-slate-900 text-slate-300 transition hover:border-slate-700 hover:bg-slate-800">
        ...
        <p className="mt-6 border-t border-slate-800 pt-6 text-xs text-slate-600">© 2026 Alkhafeef LLC</p>
      </div>
    </footer>
  )
}
